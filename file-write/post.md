...
2. Имеет свой транзакционный API, но разработчикам [рекомендуется искать](https://learn.microsoft.com/en-us/windows/win32/fileio/deprecation-of-txf#abstract) ему альтернативы
