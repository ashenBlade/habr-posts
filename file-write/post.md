...
Как видно, разница заметна: время выполнения при буферизации меньше примерно в (TODO: сколько) раза. Код бенчмарка расположен [здесь](https://github.com/ashenBlade/habr-posts/blob/file-write/file-write/src/FileWrite.Benchmarks/FileWriteBenchmarks.cs).
