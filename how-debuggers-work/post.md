...
- [STABS](https://sourceware.org/gdb/current/onlinedocs/stabs.html) (Symbol TABle Strings) - один из первых форматов отладочных символов (1980-е). Название исходит из того, что все данные для отладки хранились в виде простых строк в символах объектного файла (тогда еще `a.out` - не ELF).
