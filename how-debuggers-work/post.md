...
PDB, Program DataBase - это формат файлов с отладочной информацией. В отличие
от выше перечисленных форматов, этот хранится всегда во внешнем файле, то есть
отладочная информация и объектный файл хранятся раздельно.
