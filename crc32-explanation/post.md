...
Но это еще не совсем конец. Вычисление CRC настолько популярная операция, что она реализована в машинных инструкциях 

   - A painless guide to crc error detection code
