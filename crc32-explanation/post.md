...
Попробуем умножить 2 многочлена в этой арифметике: 
`(x^4 + x^2 + 1) * (x^3 + x^2 + x) = 
...
Дело в том, что CRC работает в терминах многочленов над конечным полем GF(2) - "полиномиальная арифметика по модул ю 2". 
...
- Делитель - другой многочлен (его называют порождающим многочленом);
...
Значение для обычного табличного алгоритма - TODO

### TODO: визуализация для обычного табличного алгоритма

Для нового табличного алгоритма теперь вычислим изначальное значение регистра 

### TODO: вычисление нового значения регистра

А теперь вычислим чек-сумму по новому алгоритму

### TODO: вычисление чек-суммы по новому табличному алгоритму
