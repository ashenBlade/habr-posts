...
Для примера рассчитаем табличное значение для `0110`, а полином возьмем из предыдущего примера:

![Вычисление табличного значения](img/table-value-calculation.gif)
...
![Простой табличный алгоритм](img/table-algorithm.gif)
